...
```json
{
  "categories": [
    ...
    // ... 6 more categories (Business, Entertainment, Technology, Local, National, World)
  ]
}
```
...
**Seeded Data:**
- **8 Categories**: Politics, Sports, Business, Entertainment, Technology, Local, National, World
