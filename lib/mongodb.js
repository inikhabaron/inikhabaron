...
const mongoOptions = {
  ...
  retryWrites: true,
  retryReads: true,
  // Compress wire-protocol traffic with zlib. Over a high-latency remote
  // connection this reduces bytes-in-flight and can cut transfer time by
  // 60-80% for typical JSON-heavy documents like news articles.
  compressors: ['zlib'],
};
