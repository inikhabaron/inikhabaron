...
// Round-robins across per-category queues (each preserving its original
// score-sorted order) instead of the previous findIndex()+splice() loop,
// which was O(n^2) over the up to ~500 candidate articles scored above.
